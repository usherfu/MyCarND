...
- Keras 1.x api docs: https://faroit.github.io/keras-docs/1.2.2/layers/convolutional/#convolution2d

- Keras 2.x api docs: 

- [This discusses feature map](https://github.com/windowsub0406/Behavior-Cloning)
- Using [quiver](https://github.com/keplr-io/quiver) to [show internal of all conv layers](https://github.com/jinchenglee/CarND-Behavioral-Cloning) 

- [!!!Must-know tips on deep learning](https://www.kdnuggets.com/2016/03/must-know-tips-deep-learning-part-1.html)

- [!!!Augmentation of image](https://chatbotslife.com/using-augmentation-to-mimic-human-driving-496b569760a9) 
